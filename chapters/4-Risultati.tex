...
In figura \ref{fig:risultati-cuda-opencl} si trova la comparazione percentuale delle
...
Come dimostrazione finale, si vogliono portare i risultati delle simulazione
